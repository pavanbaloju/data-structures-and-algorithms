...
// Intuition:
// We can use binary search to find the square root of x. We iterate through the possible square root values and narrow down the search space based on the comparison of the square of the mid value with x.
