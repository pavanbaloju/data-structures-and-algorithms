...
// Intuition:
// To find the largest rectangle area, we need to consider each bar as the potential height of a rectangle
// and calculate its width by finding the range of bars that can extend to the left and right of the current bar without decreasing in height. 
// We can use a stack-based approach to efficiently find these ranges.
